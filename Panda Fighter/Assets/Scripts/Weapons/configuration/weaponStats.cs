...
public class WeaponStats : MonoBehaviour
{
    ...
    public WeaponStats(CentralWeaponSystem weaponSystem)
    {
        ...
        set(WeaponTags.PlasmaOrb, Mode.gun, Type.singleFire, 0, 52, 300, l.Short_barrel, w.PlasmaOrbLauncher);

        set(WeaponTags.Railgun, Mode.gun, Type.holdFire, 0.5f, 120, 300, l.Middle_barrel, w.Shielder);
        ...
        set(WeaponTags.FocusBeamer, Mode.gun, Type.holdFire, 0, 72, 300, l.Short_barrel, w.FocusBeamer);
    }
