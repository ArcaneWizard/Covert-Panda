...
{
    public NormalJumpAction(AIActionType action, int direction, Vector2 speed, Vector2 timeB4Change, Vector2 changedSpeed,
    ...
    public NormalJumpAction(int dir) : base(dir) { }
}
